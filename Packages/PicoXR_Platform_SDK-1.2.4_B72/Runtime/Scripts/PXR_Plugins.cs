...
namespace Unity.XR.PXR
{
    ...
    public static class PXR_Plugin
    {
        ...
        public static class Render
        {
            ...
            public static void UPxr_SetSystemDisplayFrequency(float rate)
            {
#if ANDROID_DEVICE
            ...
            public static void UPxr_SetDisplayFrequency(float rate)
            {
#if ANDROID_DEVICE
        ...
        public static class System
        {
            ...
            public static void ControlSetDeviceAction(DeviceControlEnum dEVICE_CONTROL_SHUTDOWN, object callback)
            {
                throw new NotImplementedException();
            }

            public static void ControlSetDeviceAction(DeviceControlEnum dEVICE_CONTROL_SHUTDOWN, Action<int> testCallback)
            {
                throw new NotImplementedException();
            }
        }
        ...
        public static class Controller
        {
            ...
            public static int UPxr_GetControllerHandness()
            {
                int handness = -1;
#if ANDROID_DEVICE
